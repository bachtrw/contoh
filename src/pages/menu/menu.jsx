...
export default function Menu(){
    ...
    let onGetData = async() => {
        try {
            let response = await axios.get('http://my-json-server.typicode.com/bachtrw/jcwd2302/products?category=0')
            let responseCategory = await axios.get('http://my-json-server.typicode.com/bachtrw/jcwd2302/category')
    ...
    let onFilter = async(idx) => {
        let response = await axios.get(`http://my-json-server.typicode.com/bachtrw/jcwd2302/products?category=${idx}`)
